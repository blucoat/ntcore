...
class Message {
 ...
 public:
  ...
  wpi_llvm::StringRef str() const { return m_str; }
  ...
  static std::shared_ptr<Message> ClientHello(wpi_llvm::StringRef self_id);
  static std::shared_ptr<Message> ServerHello(unsigned int flags,
                                              wpi_llvm::StringRef self_id);
  static std::shared_ptr<Message> EntryAssign(wpi_llvm::StringRef name,
                                              unsigned int id,
